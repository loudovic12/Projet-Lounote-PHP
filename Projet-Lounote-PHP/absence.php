...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
        <form action="Db/dbAjoutDirection.php" method="post">
          <div class="container">
            <div class="offset-2 col-md-8 col-xs-2">
                    <div class="form-area text-center">
                        <br>
                        <div class="form-group">
                        <input type="date" id="date" name="date" value="2019-02-17" min="2019-01-01" max="2019-12-31">
                    </div>
                    </div>
                  </div>
                  <input type="submit" name="submit" class="btn btn-primary btn-block" value="Ajouter l'absence">
