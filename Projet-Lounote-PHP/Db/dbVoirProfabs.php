...
$etudiant = new Etudiant (['professeurs_id'=>$_POST['professeurs_id']]);  //on envoit la valeur contenue dans le post dans la classe Etudiant
...
$m=$manager -> selectprofabs($professeur);
