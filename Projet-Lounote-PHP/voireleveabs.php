...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
  ...
  <div id="wrapper">
    ...
    <div class="card card-register mx-auto mt-5">
        <div class="card-header"><h3>Affichage des élèves absents</h3></div>
        ...
        $ma=$manager -> selectetuabs();
        //cette variable va appeler la fonction selectetuabs() se trouvant dans la classe directionManager
      ?>
