...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
  ...
  <div id="wrapper">
    ...
    <div class="card card-register mx-auto mt-5">
        <div class="card-header"><h3>Affichage des élèves retards</h3></div>
        ...
        $ma=$manager -> selectretardetu();
        //cette variable va appeler la fonction selectretardetu() se trouvant dans la classe directionManager
      ?>
          ...
          <table class="table table-bordered">
            ...
            <?php  foreach ($ma as $m){
              ...
              <tr>
                                        ...
                                        <td> <?php echo $m['COUNT(etudiants_id)'];?></td>
                                          <td> <?php echo $m['Nom']; ?></td>

                                            <td> <?php echo $m['Prenom']; ?></td>
                                        <td> <?php echo $m['date_retard']; ?></td>
                      </tr>
